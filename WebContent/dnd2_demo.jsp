...
<head>
	...
	<script>
		...
		function addProduct(name,price){
			...
			totalCost += price;
            s=s+name+":"+price+":"+"1"+","
            $("input[id=productsSelected]").val(s);
...
<center><h4>Welcome <%=session.getAttribute("name")%>!!</h4></center>
	<ul class="products">
        <%
		...
		<li>
			<a href="#" class="item">
				...
				<div>
					...
					<p>Price:$<%=resultset.getString(4)%></p>
				</div>
			</a>
		</li>
        <%
	...
	<div class="cart">
        ...
        <form action="OrderSummary.jsp" method="post">
            <input type="hidden" id="productsSelected" name="productsSelected" value="">
            <input type="submit" src="img/checkout.png" value="Procceed to Checkout" />
        </form>
        </center>
